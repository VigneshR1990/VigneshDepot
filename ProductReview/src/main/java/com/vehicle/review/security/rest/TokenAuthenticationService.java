...
public class TokenAuthenticationService {
	...
	public String createTokenForUser(User user) {
		...
		//user.setExpires(System.currentTimeMillis() + expiresMS);
	...
	public Authentication getAuthentication(HttpServletRequest request, HttpServletResponse response) {
		...
		LOGGER.debug("getAuthentication : authHeaderName "+authHeaderName);
	...
	private Authentication getUserAuthFromToken(String token) {
		if (token != null) {
			...
			if (tokenUser != null) {
				...
				final UsernamePasswordAuthenticationToken loginToken = new UsernamePasswordAuthenticationToken(user,
